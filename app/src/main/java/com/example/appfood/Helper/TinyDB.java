...
public class TinyDB {
    ...
    public ArrayList<Hotels> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<Hotels> playerList =  new ArrayList<Hotels>();

        for(String jObjString : objStrings){
            Hotels player  = gson.fromJson(jObjString,  Hotels.class);
    ...
    public void putListObject(String key, ArrayList<Hotels> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(Hotels player: playerList){
